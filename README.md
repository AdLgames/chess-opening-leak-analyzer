...
- `chess_opening_analyzer/chessopening/bin/stockfish` — Stockfish 17.1 (Linux, AVX2). Run
  `python tools/install_stockfish.py` to fetch the right build for another platform.
- `chess_opening_analyzer/chessopening/data/openings.sqlite` — 157,625 games, 49,327 positions,
